...
use HatueySoft\TicketBundle\Entity\Comentario;
use HatueySoft\TicketBundle\Form\ComentarioType;
...
class ComentarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HatueySoftTicketBundle:Comentario')->findAll();
     ...
     * @Method("POST")
     * @Template("HatueySoftTicketBundle:Comentario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HatueySoftTicketBundle:Comentario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HatueySoftTicketBundle:Comentario:edit.html.twig")
     */
