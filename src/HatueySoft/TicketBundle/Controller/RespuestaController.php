...
use HatueySoft\TicketBundle\Entity\Respuesta;
use HatueySoft\TicketBundle\Form\RespuestaType;
...
class RespuestaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HatueySoftTicketBundle:Respuesta')->findAll();
     ...
     * @Method("POST")
     * @Template("HatueySoftTicketBundle:Respuesta:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            //Enviar un mensaje al usuario que genero el ticket indicandole que se le dio respuesta
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HatueySoftTicketBundle:Respuesta')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HatueySoftTicketBundle:Respuesta:edit.html.twig")
     */
