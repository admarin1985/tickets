...
class TicketController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HatueySoftTicketBundle:Ticket')->findAll();
     ...
     * @Method("POST")
     * @Template("HatueySoftTicketBundle:Ticket:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            //Enviar un mensaje al encargado de soporte del proyecto informandole del nuevo ticket
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HatueySoftTicketBundle:Ticket:edit.html.twig")
     */
