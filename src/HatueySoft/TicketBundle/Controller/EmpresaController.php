...
use HatueySoft\TicketBundle\Entity\Empresa;
use HatueySoft\TicketBundle\Form\EmpresaType;
...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HatueySoftTicketBundle:Empresa')->findAll();
     ...
     * @Method("POST")
     * @Template("HatueySoftTicketBundle:Empresa:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HatueySoftTicketBundle:Empresa')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HatueySoftTicketBundle:Empresa:edit.html.twig")
     */
