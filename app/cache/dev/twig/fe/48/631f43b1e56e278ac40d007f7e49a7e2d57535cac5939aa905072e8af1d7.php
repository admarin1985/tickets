...
/* HatueySoftTicketBundle:ClasificadorTicket:index.html.twig */
class __TwigTemplate_fe48631f43b1e56e278ac40d007f7e49a7e2d57535cac5939aa905072e8af1d7 extends Twig_Template
{
    ...
    {
        // line 8
        echo "    <h1>ClasificadorTicket list</h1>
";
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("clasificadorticket_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 43
        echo $this->env->getExtension('routing')->getPath("clasificadorticket_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "HatueySoftTicketBundle:ClasificadorTicket:index.html.twig";
    }
