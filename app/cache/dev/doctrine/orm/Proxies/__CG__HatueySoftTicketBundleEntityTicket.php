 ...
 */
class Ticket extends \HatueySoft\TicketBundle\Entity\Ticket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'id', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'tema', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'descripcion', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'fecha', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'clasificador', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'prioridad', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'estado', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'proyecto', '' . "\0" . 'HatueySoft\\TicketBundle\\Entity\\Ticket' . "\0" . 'usuario');
        }
    ...
    public function setClasificador(\HatueySoft\TicketBundle\Entity\ClasificadorTicket $clasificador)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClasificador', array($clasificador));
    ...
    public function getClasificador()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClasificador', array());
