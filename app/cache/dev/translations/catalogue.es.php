...
',
  ...
  'HatueySoftSecurityBundle' => 
  array (
    'Bad credentials' => 'Las credenciales no son correctas.',
    'usuario.data.nombres' => 'Nombres:',
    'usuario.data.apellidos' => 'Apellidos',
    'usuario.data.enabled' => 'Habilitado',
    'usuario.data.pin' => 'PIN',
    'usuario.data.roles' => 'Roles',
    'usuario.data.grupoBuses' => 'Grupo Buses',
    'usuario.btn.create' => 'Crear Usuario',
    'usuario.messages.create.error.%key%' => 'Ha ocurrido un error creando un Usuario "key".',
    'usuario.messages.create.success.%key%' => 'Se ha creado el Usuario "key" de forma satisfactoria.',
  ),
));
